pipeline {
     environment {
       ...
       APP_NAME = "ulrich"
       STG_API_ENDPOINT = "ip10-0-1-3-cc79bn4srdn0fvnms4rg-1993.direct.docker.labs.eazytraining.fr"
       STG_APP_ENDPOINT = "ip10-0-1-3-cc78bhksrdn0fvnms4pg-80.direct.docker.labs.eazytraining.fr"
       PROD_API_ENDPOINT = "ip10-0-1-4-cc79bn4srdn0fvnms4rg-1993.direct.docker.labs.eazytraining.fr"
       PROD_APP_ENDPOINT = "ip10-0-1-4-cc78bhksrdn0fvnms4pg-80.direct.docker.labs.eazytraining.fr"
       INTERNAL_PORT = "5000"
     ...
     stage('Push image in staging and deploy it') {
      ...
      steps {
          httpRequest contentType: 'APPLICATION_JSON', httpMode: 'POST', requestBody: '{"your_name":"${APP_NAME}","container_image":"${CONTAINER_IMAGE}", "external_port":"${EXTERNAL_PORT}", "internal_port":"${INTERNAL_PORT}"}', responseHandle: 'NONE', url: 'http://ip10-0-1-3-cc79bn4srdn0fvnms4rg-1993.direct.docker.labs.eazytraining.fr', wrapAsMultipart: false
          script {
            sh '''
